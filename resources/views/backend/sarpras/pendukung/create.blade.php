            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Sarpras Pendukung</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pendukung.action') }}" method="POST" class="user">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="baik" value="{{ old('baik') }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputKondisiRusak" class="form-label">Kondisi Rusak</label>
                                    <input type="text" class="form-control" name="rusak" value="{{ old('rusak') }}">
                                </div>
