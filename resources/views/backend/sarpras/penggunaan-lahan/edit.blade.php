            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Penggunaan Lahan</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pl.update', ['pl' => $pl]) }}" method="POST" class="user">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="keterangan"
                                        value="{{ old('keterangan', $pl->keterangan) }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputMilik" class="form-label">Milik</label>
                                    <input type="text" class="form-control" name="milik" value="{{ old('milik', $pl->milik) }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputPenggunaan" class="form-label">Penggunaan</label>
                                    <input type="text" class="form-control" name="penggunaan" value="{{ old('penggunaan', $pl->penggunaan) }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputBersertifikat" class="form-label">Bersertifikat (Luas m<sup>2</sup>)</label>
                                    <input type="text" class="form-control" name="bersertifikat" value="{{ old('bersertifikat', $pl->bersertifikat) }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputBelumBersertifikat" class="form-label">Belum Bersertifikat (Luas m<sup>2</sup>)</label>
                                    <input type="text" class="form-control" name="belum_sertifikat" value="{{ old('belum_sertifikat', $pl->belum_sertifikat) }}">
                                </div>
