                            ...
                            <div class="card mb-3 bg-primary text-light" style="max-width:auto">
                                <div class="row g-0">
                                    <div class="col-md-4 d-flex justify-content-center align-items-center">
                                        <div class="rounded-circle overflow-hidden bg-white p-2 img-thumbnail mt-4 mb-4"
                                            style="width: 250px; height: 250px;">

                                            @if ($kp->photo != null)
                                            <img src="{{ asset('storage/uploads/' . $kp->photo) }}"
                                                style="max-width:100%; max-height:100%; object-fit: cover; transform: scale(1.2);"
                                                alt="...">

                                            @else
                                            <img src="{{ asset('assets/img/kepala-pendidikan.jpg') }}"
                                                style="max-width:100%; max-height:100%; object-fit: cover; transform: scale(1.2);"
                                                alt="...">
                                            @endif
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h3 class="card-title"><strong>Profile Kepala Pendidikan</strong></h3>

                                            <div class="mb-3 mr-3">
                                                <label class="form-label">Nama</label>
                                                <input class="form-control" type="text" value="{{ $kp->nama }}"
                                            ...
                                            <p class="card-text">
                                                @php
                                                $elapsed = $kp->updated_at->diffInMinutes();
                                                if ($elapsed >= 60) {
