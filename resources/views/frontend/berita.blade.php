...
<body id="page-top">
    ...
    <!-- Page Header-->
    <header class="masterhead" style="background-image: url('assets/img/room-2.jpg')">
        <div class="container position-relative px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="post-heading">
                        <h1 class="display-3 lh-1 mb-3 text-white">Man must explore, and this is exploration at its
                            greatest</h1>
